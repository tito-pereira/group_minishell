...
/*   Updated: 2024/06/27 22:45:22 by marvin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	blt_central(t_execlist *execl, int i, char **exec_str, int mode)
{
	...
	if (ft_strncmp(exec_str[0], "cd", 3) == 0 && mode == 1)
	...
	else if (ft_strncmp(exec_str[0], "env", 4) == 0 && mode == 1)
    ...
    else if (ft_strncmp(exec_str[0], "export", 7) == 0 && mode == 1)
    ...
    else if (ft_strncmp(exec_str[0], "unset", 6) == 0 && mode == 1)
